...
/*package*/ final class DexPathList {
     ...
     */
    public DexPathList(java.lang.ClassLoader definingContext, ByteBuffer[] dexFiles) {
     ...
     */
    public DexPathList(java.lang.ClassLoader definingContext, String dexPath,
    ...
    private static Element[] makeDexElements(List<File> files, File optimizedDirectory,
            List<IOException> suppressedExceptions, java.lang.ClassLoader loader) {
     ...
     */
    private static DexFile loadDexFile(File file, File optimizedDirectory, java.lang.ClassLoader loader,
                                       Element[] elements)
            throws IOException {
        if (optimizedDirectory == null) {
    ...
    /*package*/ static class Element {
        ...
        public Class<?> findClass(String name, java.lang.ClassLoader definingContext,
