...
public interface IActivityManager extends IInterface {
    ...
    public int addAppTask(IBinder activityToken, Intent intent,
                          android.app.ActivityManager.TaskDescription description, Bitmap thumbnail) throws RemoteException;
    public Point getAppTaskThumbnailSize() throws RemoteException;
    public List<RunningTaskInfo> getTasks(int maxNum, int flags) throws RemoteException;
    public List<android.app.ActivityManager.RecentTaskInfo> getRecentTasks(int maxNum,
                                                                           int flags, int userId) throws RemoteException;
    public android.app.ActivityManager.TaskThumbnail getTaskThumbnail(int taskId) throws RemoteException;
    public List<RunningServiceInfo> getServices(int maxNum, int flags) throws RemoteException;
    public List<android.app.ActivityManager.ProcessErrorStateInfo> getProcessesInErrorState()
            throws RemoteException;
    ...
    public void getMemoryInfo(android.app.ActivityManager.MemoryInfo outInfo) throws RemoteException;
